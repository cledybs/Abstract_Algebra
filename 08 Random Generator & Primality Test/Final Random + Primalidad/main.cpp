...
int main(){
    ...
    //ZZ num = conv<ZZ>("55079");

    //ZZ num = conv<ZZ>("2405004167");

    //ZZ num = conv<ZZ>("13899400287462393527");

    //ZZ num = conv<ZZ>("265733069836953021104589357293605940039");

    //ZZ num = conv<ZZ>("105418067230565229302401311614871856367337516926256261485610678970677326732123");

    //ZZ num = conv<ZZ>("11067322688211763879127710781245770200266306579753149074670002771714059738841730056577765602839652195914873916936503030794140872851579504321364488742771259");
